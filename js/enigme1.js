document.addEventListener('DOMContentLoaded', function() {
  ...
  function initGame() {
    var roles = [
      { emoji: '👨‍🍳', title: 'CHEF DE CUISINE', sub: 'Le patron des fourneaux', correct: 'Il dirige toute la cuisine : il crée les recettes, supervise l\'équipe et goûte chaque plat avant qu\'il parte en salle', wrongs: ['Il fait uniquement la vaisselle et nettoie la cuisine', 'Il accueille les clients et prend les réservations'], explain: 'Le Chef, c\'est le boss de la cuisine. Il décide du menu et tout le monde suit ses ordres !' },
      { emoji: '🧑‍🍳', title: 'COMMIS DE CUISINE', sub: 'L\'apprenti en cuisine', correct: 'Il prépare les ingrédients, épluche les légumes et assiste les cuisiniers plus expérimentés', wrongs: ['Il gère la comptabilité et les finances du restaurant', 'Il conduit le camion de livraison des aliments'], explain: 'C\'est le premier poste en cuisine — tout le monde commence commis avant de monter en grade !' },
      { emoji: '🍷', title: 'SOMMELIER', sub: 'L\'expert des vins', correct: 'Il conseille les clients sur le choix du vin en accord avec leur plat et gère la cave', wrongs: ['Il prépare les cocktails et les jus de fruits au bar', 'Il fait le ménage de la salle après le service'], explain: 'Le sommelier a un nez incroyable ! Il peut reconnaître des centaines de vins différents.' },
      { emoji: '🤵', title: 'MAÎTRE D\'HÔTEL', sub: 'Le chef de la salle', correct: 'Il accueille les clients, les place à leur table et coordonne tout le service en salle', wrongs: ['Il cuisine les desserts et les pâtisseries', 'Il répare les équipements cassés de la cuisine'], explain: 'Le maître d\'hôtel est le premier visage que les clients voient — l\'image du restaurant !' },
      { emoji: '🧹', title: 'PLONGEUR', sub: 'L\'indispensable', correct: 'Il lave toute la vaisselle, les ustensiles et maintient la cuisine propre pendant le service', wrongs: ['Il plonge dans la piscine de l\'hôtel pour vérifier l\'eau', 'Il prépare les entrées froides et les salades'], explain: 'Sans plongeur, aucun restaurant ne tourne ! C\'est souvent le premier job en restauration.' },
      { emoji: '🥐', title: 'PÂTISSIER', sub: 'Le maître du sucré', correct: 'Il prépare tous les desserts, gâteaux, viennoiseries et pains du restaurant', wrongs: ['Il s\'occupe uniquement de griller les viandes', 'Il gère les réservations par téléphone'], explain: 'Le pâtissier est un artiste ! Il peut travailler en restaurant, en boulangerie ou en hôtel.' },
      { emoji: '🔥', title: 'CHEF DE PARTIE', sub: 'Le spécialiste d\'un poste', correct: 'Il est responsable d\'un secteur précis : les viandes, les poissons, les sauces ou les garnitures', wrongs: ['Il est le DJ qui met la musique dans le restaurant', 'Il livre les plats à domicile en vélo'], explain: 'Saucier, poissonnier, rôtisseur… chaque chef de partie est expert de son domaine !' },
      { emoji: '📋', title: 'SERVEUR', sub: 'Le lien avec le client', correct: 'Il prend les commandes des clients, apporte les plats et s\'assure que tout se passe bien à table', wrongs: ['Il décide du prix des plats sur le menu', 'Il choisit les ingrédients au marché le matin'], explain: 'Un bon serveur connaît le menu par cœur et sait conseiller les clients !' }
    ];
