document.addEventListener('DOMContentLoaded', function() {
  ...
  function showSituation() {
    ...
    // Choisir 3 pros : le bon + 2 autres
  ...
  function endGame() {
    // ICI ON DEMANDE 3 BONNES RÉPONSES
  ...
  function showResult(success, score) {
    ...
    if (resultScore) resultScore.textContent = score + ' / ' + total + ' situations résolues';
